...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $secondaryAddressFormats = array('Wohnung ##', 'Flat ##?', 'Studio ##', 'Studio ##?');
